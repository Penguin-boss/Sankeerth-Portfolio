...
export const projects: Project[] = [
  {
    ...
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "AI Dev Tools", "Database Setup"],
    github: "https://github.com/Cha129/VersaCareerAI",
    live: "https://versacareer.netlify.app",
  },
  {
    id: "desi-drip",
    name: "Desi-Drip",
    ...
    stack: ["React", "TypeScript", "Tailwind CSS", "Backend Configuration", "Testing"],
    github: "https://github.com/Penguin-boss/Desi-Drip",
    live: "https://desi-drip.vercel.app",
  },
  {
    id: "shiva-kanaka",
    ...
    role: ["Frontend Developer", "UI/UX Design", "Deployment"],
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],
    github: "https://github.com/Penguin-boss/Shiva-kanaka",
    live: "https://kanakashiva.vercel.app",
  },
  {
    id: "settlex",
    name: "SettleX",
    ...
    stack: ["Mobile App", "React Native", "Database Setup", "Backend Setup"],
  ...
  },
  {
    ...
    role: ["Game design", "Frontend build"],
...
export const hackathon = {
  ...
  rounds: [
    ...
    { label: "Round 4 — Interview", result: "Top 10", note: "Completed final round" },
  ],
  summary:
...
export const certificates: Certificate[] = [
  {
    ...
    description: "Certification in Front-End Web Development, responsive layout, and web integration.",
  },
  {
    id: "web-dev",
    ...
    description: "Certification in web application development, HTML/CSS/JS, and full software workflows.",
  },
  {
    id: "hackathon-r1",
    ...
    description: "Certificate of Excellence for scoring in the Top 3 in Aptitude & Core Concepts.",
  },
  {
    id: "hackathon-r2",
    ...
    description: "Qualification certificate for advancing through the project submission phase.",
  },
  {
    id: "hackathon-r3",
    ...
    description: "Certificate for successfully completing the live hackathon building phase.",
  },
  {
    id: "hackathon-r4",
    ...
    description: "Finalist certificate for finishing in the Top 10 overall in the final round.",
  },
];
...
export const experience = [
  ...
  {
    id: "hackathon",
    title: "Enginow Hackathon — WishCraft Studios",
    period: "Rounds 1–4",
    description:
  ...
  },
  {
    ...
    period: "VersaCareer AI · Desi-Drip · SettleX · Shiva Kanaka",
    description:
